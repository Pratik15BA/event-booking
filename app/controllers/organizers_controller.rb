class OrganizersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to organizers_path, status: :see_other, notice: "Organizer was successfully destroyed." }
  ...
  private
    ...
    def organizer_params
      params.require(:organizer).permit(:name, :email_id, :contact_no)
    end
end
