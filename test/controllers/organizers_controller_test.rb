...
class OrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organizer" do
    assert_difference("Organizer.count") do
      post organizers_url, params: { organizer: { contact_no: @organizer.contact_no, email_id: @organizer.email_id, name: @organizer.name } }
    end
  ...
  test "should update organizer" do
    patch organizer_url(@organizer), params: { organizer: { contact_no: @organizer.contact_no, email_id: @organizer.email_id, name: @organizer.name } }
